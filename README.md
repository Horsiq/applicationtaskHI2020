...
From the start activity, if the user presses the information button in the top right corner, they will be presented a list of all the ACTs that is registrable. By clicking on one of the items in the lists they get more comprehensive information regarding that ACT. For example, it can show information regarding the problems evolving that ACT, what you need to do to register that ACT and how many points you get. The points system is based on the level of impact the ACTs has on climate change. By clicking the button, the user will be directed to the register activity.
